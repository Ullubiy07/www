    ...
    render() {
        return (
            <div className="post" ref={(item) => this.postDiv = item}>
                ...
                <h3 style={{fontWeight: "bold"}}>{this.props.post.firstname}</h3>
                <h4 style={{color: "white", fontWeight: "100", textIndent: "5px"}}>{this.props.post.info}</h4>
                <b>{"- " + this.props.post.job}</b>
